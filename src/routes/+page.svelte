...
<svelte:head>
	<meta name="title" content="Epitora: Software tailor-made for your business" />
</svelte:head>
...
<div class="fixed inset-0 overflow-hidden bg-white dark:bg-black">
	...
	<div class="mx-auto mt-46 px-4 sm:mt-64 flex flex-col items-center max-w-3xl">
		...
		<p class="mt-8 text-lg sm:text-xl/8 font-medium text-center text-pretty text-black/60 dark:text-white/80">
	...
	<div class="absolute inset-0 -z-10 transform-gpu overflow-hidden blur-3xl">
		<div
			class="absolute -top-20 left-0 w-lg sm:w-2xl aspect-1155/678 rotate-30 bg-yellow-500 opacity-35"
			style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
		></div>
		<div
			class="absolute bottom-0 right-0 w-lg sm:w-2xl aspect-1155/678 -rotate-10 bg-indigo-500 opacity-35"
			style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
		></div>
	</div>
</div>
